...
```json
{
  ...
  "sources": [
    ...
    "knowledge/COVERAGE.md — rank 13, 65 files tagged 'Bjerregaard'; rank 5, 77 files tagged 'MoN/Bjerregaard'",
    "Local aggregate over data/composers/*.json: 'Bjerregaard' tag = 65 files / 3 composers (Johannes Bjerregaard 61, Henrik Jensen 3, Swallow 1); 'MoN/Bjerregaard' tag = 77 files / 15 composers (Fozzie 17, Johannes Bjerregaard 15, ELA 9, Dokken 6, Joachim Wijnhoven 6, Widding_Roy_Johan 5, Drumtex 4, Rage 4, Zipper 3, Lynx 2, Scroll 2, Art 1, Glenn Gallefoss 1, JO 1, Trurl 1)",
