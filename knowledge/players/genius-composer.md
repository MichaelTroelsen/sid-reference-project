...
```json
{
  ...
  "quirks": [
    ...
    "Re-checked 2026-07-24: Lemon64 (lemon64.com) and Forum64 (forum64.de) were searched explicitly (site-restricted queries for 'Genius Composer'/'Dr. Zoom') and turned up no threads specific to this tool — only unrelated C64-composer-software discussions. CSDb release 94332 itself has no comments and no source/format write-up attached. This reconfirms, rather than changes, the stub status: no new provenance beyond SIDId/CSDb/C64-Wiki already cited was found."
  ],
  "sources": [
