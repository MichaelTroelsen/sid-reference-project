...
```json
{
  ...
  "quirks": [
    ...
    "Author 'Rabbi' (Radoslaw/Radek Andrzejewicz) is a Polish C64 scener associated with groups including Medium and Agnus, and also composed music under that handle (e.g. the CSDb release's own demo tune 'Erotic Malfunction')."
  ],
  "sources": [
    ...
    "CSDb release (Playstar Editor V2.0, 1996): https://csdb.dk/release/?id=122335 — code/design/idea: Rabbi; graphics: Condic",
...
disassembly was found anywhere searched (CSDb, Codebase64, general web), so
this card is identity/provenance only.
