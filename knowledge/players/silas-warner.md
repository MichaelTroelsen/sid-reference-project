...
```json
{
  ...
  "quirks": [
    ...
    "Not confirmed in SIDId beyond the bare author field already known for this tag (no name field). No documented working relationship found to any other US commercial-studio composer already in this KB — checked directly against [[ed-bogas-accolade]], [[ed-bogas-hakansson]], [[david-thiel]], [[kyle-johnson]], [[al-lowe]], [[paul-mudra]], [[rick-cardinali]], [[kenneth-arnold]], [[arti-haroutunian]] — different studios entirely (Muse Software vs. Sierra/Origin/Accolade/Gottlieb/Tronix/Music Sales Ltd elsewhere in this KB), no cross-source mention of collaboration found."
  ],
  "sources": [
