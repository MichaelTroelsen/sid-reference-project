...
```json
{
  ...
  "edges": {
    "derives_from": [],
    "successor_of": ["unknown-c64-driver"],
    "shares_routine_with": [],
  ...
  "quirks": [
    ...
    "csdb_release gap re-checked (2026-07-31): full census of all 8 tagged files' CSDb SID-entry `Released` fields via scripts/lib/csdb-client.js (type=sid) confirms the range already recorded — Desolator/Predator/Strategic Defence Initiative/Espionage are all dated 1988, Fighter Bomber/Fighting Soccer 1989, Strike Aces/Sonic Boom 1990 — with no file predating VGMPF's stated Feb 1988 supersession date. Additional targeted searches on csdb.dk (site search + advanced search for 'Source'), Lemon64 forum, and Forum64.de (German) for a dedicated tool/release/group page for this driver or a discussion of its authorship all returned nothing relevant — no CSDb release id exists for this driver as a standalone tool, so csdb_release stays null. No community thread was posted to ask; per instructions this project's research stays read-only."
  ],
  "sources": [
    ...
    "CSDb — full census of all 8 '?Source_2'-tagged SID entries via the webservice (type=sid), each with its own `Released` field: Desolator id=42440 '1988 US Gold' https://csdb.dk/sid/?id=42440, Fighter Bomber id=1391 '1989 Activision' https://csdb.dk/sid/?id=1391, Fighting Soccer id=17381 '1989 Activision' https://csdb.dk/sid/?id=17381, Predator id=47582 '1988 Activision' https://csdb.dk/sid/?id=47582, Strategic Defence Initiative id=47282 '1988 Activision' https://csdb.dk/sid/?id=47282, Strike Aces id=51806 '1990 Accolade' https://csdb.dk/sid/?id=51806, Espionage id=1372 '1988 Grandslam' https://csdb.dk/sid/?id=1372, Sonic Boom id=1883 '1990 Activision/Sega' https://csdb.dk/sid/?id=1883",
    "csdb.dk site search (advanced search for 'Source') and general web search for a CSDb group/tool/release page for this driver: no dedicated page found, checked 2026-07-31",
    "Lemon64 forum (lemon64.com) and Forum64.de searched by name for 'Source' + Leeds/Paul Summers/driver discussion: no relevant thread found, checked 2026-07-31",
    "sidid: no entry found for '?Source' or '?Source_2' in deepsid_dl/sidid.nfo (checked directly) — SIDId does not carry this tag",
    "Local dataset: 8 files tagged '?Source_2' across 2 composer folders (data/composers/paul-summers.json: Desolator, Fighter Bomber, Fighting Soccer, Predator, Strategic Defence Initiative, Strike Aces; data/composers/source-the-software-house.json: Espionage, Sonic Boom) — full census confirmed 2026-07-31, matches count and titles previously recorded; see knowledge/COVERAGE.md family '?Source' (12 files combined with the distinct '?Source' tag; see quirks for the split)"
  ]
}
```
...
Fighter Bomber credits page, and a full census (all 8, not a sample) of
CSDb SID-entry `Released` fields. A 2026-07-31 gap-filling pass re-checked
`csdb_release` specifically — csdb.dk site search, Lemon64, and Forum64.de
were all searched by name for a dedicated tool/release/group page for this
driver; none exists, so `csdb_release` stays `null` on confirmed negative
evidence rather than an unchecked gap.
